/** ISO 3166-1 alpha-2 codes + English short names + ITU-T E.164 calling codes, for the Profile/Settings country selector and the phone number "Country code" selector. `code` matches the API's @IsISO31661Alpha2() validation. `dial` has no leading "+" and can repeat across countries (e.g. the NANP "1" for US/Canada/Jamaica/...); see lib/phone.ts for how it's turned into a flag + code option and combined into an E.164 number. */
